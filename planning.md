...
Our data consists of a distinct mix of both ultra-short, single-sentence student reviews and longer, multi-paragraph forum posts. A smaller chunk size of 500 characters ensures that short, punchy reviews do not get combined and diluted with unrelated feedback from other reviews. The 100-character overlap guarantees semantic continuity so that sentences spanning across a boundary do not lose their structural context during retrieval. 42 final chunks
